...
public class TwoAgentsODDemo implements Creator {
    ...
    public void create() {
        ...
        EarliestArrivalProblem problem = new SuperconflictProblem(2, 50);
    ...
    private Trajectory[] solve(EarliestArrivalProblem problem) {
        ...
        ODSolver solver = new ODSolver(starts,
                goals,
                motions,
    ...
    private DirectedGraph<Point, Straight> createMotionGraph(final tt.euclid2i.Point init, final tt.euclid2i.Point goal, Rectangle bounds, Collection<tt.euclid2i.Region> obstacles, int maxTime) {

        LazyGrid grid = new LazyGrid(init,
                obstacles,
                bounds,
                LazyGrid.PATTERN_4_WAY_WAIT,
                GRID_STEP);
        ...
        VisManager.registerLayer(RegionsLayer.create(
                new RegionsProvider() {
                    ...
                    public Collection getRegions() {
                        LinkedList<tt.euclid2i.Region> list = new LinkedList<tt.euclid2i.Region>();
